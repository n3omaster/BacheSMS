...
import com.bachecubano.nautabackgroundlibrary.util.NautaSender;
...
public class BackgroundMail {
    ...
    private final static String TYPE_PLAIN = "text/plain";
    private final static String TYPE_HTML = "text/html";
    ...
    private BackgroundMail(Builder builder) {
        ...
        //Notifications via Toast disabled
    ...
    public void setNautaUserName(@NonNull String string) {
        this.username = string;
    }

    public void setNautaUserName(@StringRes int strRes) {
        this.username = mContext.getResources().getString(strRes);
    }

    @NonNull
    public String getNautaUserName() {
        return username;
    }

    public void setNautaPassword(@NonNull String string) {
        this.password = string;
    }

    public void setNautaPassword(@StringRes int strRes) {
    ...
    private void send() {
        ...
        if (TextUtils.isEmpty(mailto)) {
            throw new IllegalArgumentException("You didn't set a Nauta recipient");
        }
        ...
        if (!Utils.isNetworkAvailable(mContext)) {
            ...
            Log.d(TAG, "Necesitas una conexion a internet para poder enviar el correo");
        }
    ...
    public class SendEmailTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... arg0) {
            try {
                NautaSender sender = new NautaSender(username, password);
    ...
    public static final class Builder {
        ...
        public Builder withType() {
            this.type = BackgroundMail.TYPE_PLAIN;
            return this;
        }
