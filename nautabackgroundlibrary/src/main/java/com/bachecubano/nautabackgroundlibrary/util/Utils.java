...
public class Utils {
    ...
    private static final String cryptoPass = "Thi$IsMyhAsH";

    public static boolean isNetworkAvailable(Context context) {
        return ((context.getSystemService(Context.CONNECTIVITY_SERVICE)) != null ? ((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo() : null) != null;
    }
